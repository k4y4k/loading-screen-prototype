...
export class MultiTextureAltas extends BaseDemo {
  ...
  public constructor() {
    ...
    factory.parseDragonBonesData(
      Loader.shared.resources['dragon/effect/effect_ske.json'].data,
      'hd',
      1.0
    )
    factory.parseDragonBonesData(
    ...
    factory.parseTextureAtlasData(
      Loader.shared.resources['dragon/effect/effect_tex.json'].data,
      Loader.shared.resources['dragon/effect/effect_tex.png'].texture,
      'hd',
      1.0
    )
    factory.parseTextureAtlasData(
    ...
    this._armatureDisplayA = factory.buildArmatureDisplay(
      'flower',
      'hd',
      null,
      'hd'
    ) // HD Armature and HD TextureAtlas.
    this._armatureDisplayB = factory.buildArmatureDisplay(
      'flower',
      'hd',
      null,
      'sd'
    ) // HD Armature and SD TextureAtlas.
    this._armatureDisplayC = factory.buildArmatureDisplay(
      'flower',
      'sd',
      null,
      'hd'
    ) // SD Armature and HD TextureAtlas.
    this._armatureDisplayD = factory.buildArmatureDisplay(
      'flower',
      'sd',
      null,
      'sd'
    ) // SD Armature and SD TextureAtlas.
  ...
  private _changeAnimation(): void {
    ...
    if (animationName) {
      ...
      const animationIndex =
        (animationNames.indexOf(animationName) + 1) % animationNames.length
      this._armatureDisplayA.animation.play(
