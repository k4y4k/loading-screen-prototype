  ...
  private _dragHandler(event: interaction.InteractionEvent): void {
    switch (event.type) {
      ...
      case 'mousedown':
        ...
        const armatureDisplay = this._dragDisplayObject
          .parent as dragonBones.PixiArmatureDisplay
        const bone = armatureDisplay.armature.getBoneByDisplay(
