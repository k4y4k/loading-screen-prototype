...
export class BoneOffset extends BaseDemo {
  public constructor() {
    ...
    factory.parseDragonBonesData(
      Loader.shared.resources['dragon/bullet_01/bullet_01_ske.json'].data
    )
    factory.parseTextureAtlasData(
      Loader.shared.resources['dragon/bullet_01/bullet_01_tex.json'].data,
      Loader.shared.resources['dragon/bullet_01/bullet_01_tex.png'].texture
    )
